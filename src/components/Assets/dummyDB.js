...
//Available hotel spaces aray of properties
export const Hotel = [
  {
    id: "1",
    img: Star,
...
//Trending brands array of objects
export const TrendingBrand = [
  {
    id: 1,
    image: Tobams,
    title: "Tobams Colors",
