  ...
  return (
    <div className="w-screen max-h-max  py-8">
      <div className="w-[90%] mx-auto flex justify-center items-center flex-col">
          <SecctionHeader title={"Meet Our Verified Exclusive Brands"}/>
        <div className="w-full flex justify-center items-center bg-Pink">
          <div className=" flex-1">
            <img className="w-full h-full object-cover" src={exclusive} alt="brand" />
          </div>
          <div className="flex-1">
            <div className="ml-16 mb-7 flex justify-center flex-col gap-4 text-[15px] text-textGrey font-normal">
              <h4>Exceptional Brands</h4>
              <h4>Exclusive Brands</h4>
              <h4>Verified for Quality Services</h4>
            </div>
            <div className="ml-16">
              <button className="bg-white text-xs text-deepWine font-normal rounded-md flex justify-center items-center py-3 px-4 shadow-md">
                learn more{" "}
                <span className="ml-3">
                  <svg
                    width="10"
